...
<dt>
	...
	<p>_Figure 1_: Behold! A graphical demonstration of Jensen's Inequality. The expectations shown are with respect to an arbitrary discrete distribution over the $x_i$</p>
</dd>
</dl>
